package cn.anthony.moscreen.mr;
 ...
 * Http提交,默认采用Get方法
 ...
 接收成功后返回：OK
 例子：http://127.0.0.1/sms/sync.jsp?mobile=...&mo=...&port=...&linkid=...&time=.....&status=DELIVRD&price=...
 ...
 status 状态值，(固定值DELIVRD，表示成功)
 price 计费金额（单位分）

 说明：
 1）mo上行内容和time这两个参数传输前做url编码
