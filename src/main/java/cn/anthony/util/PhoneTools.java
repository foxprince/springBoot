...
public class PhoneTools {
	...
	return true;
	/*
	 * if (phone.length() != 11) return false; else { String phoneHead =
	 * phone.substring(0, 3); if ((!phoneHead.equals("130")) &&
	 * (!phoneHead.equals("131")) && (!phoneHead.equals("132")) &&
	 * (!phoneHead.equals("133")) && (!phoneHead.equals("134")) &&
	 * (!phoneHead.equals("135")) && (!phoneHead.equals("136")) &&
	 * (!phoneHead.equals("137")) && (!phoneHead.equals("138")) &&
	 * (!phoneHead.equals("139"))) return false; else return true; }
	 */
    }
