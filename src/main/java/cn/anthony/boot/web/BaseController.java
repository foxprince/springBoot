...
public class BaseController {
	...
	model.addAttribute("message", "你好。Maven Web Project + Spring 3 MVC - welcome()");
	return "index";
    }
    ...
    public @ResponseBody Map<String, Object> mo(@PathVariable String name, @RequestParam Map<String, String> allRequestParams) {
	...
	model.addAttribute("message", "你好。Maven Web Project + Spring 3 MVC - " + name);
	return "index";
    }
