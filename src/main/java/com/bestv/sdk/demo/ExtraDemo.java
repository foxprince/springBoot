...
public class ExtraDemo {
	...
	private static ExtExtraRequestInfo initRequestInfo(String realMobile,String tradeCode,String orderId,String verifyCode,String telephone,String transactionId) {
        ...
        extraRequestInfo.setServiceType("verify");
        	...
        	dataParams.put(DataContants.MOBILE,
                    SecurityUtils.aesEncrypt(realMobile, BestvParams.APPKEY));
        	//短信中获取到的验证码
	...
	private static ExtExtraResponseInfo miguDdoVerify(ExtExtraRequestInfo requestInfo) {
        ...
        try {
            final String respBody = HttpUtils.postRstr(EXTRA_HOST,
                    StringUtils.getBytes(body), headers);
