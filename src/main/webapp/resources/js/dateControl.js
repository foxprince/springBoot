...
function WebCalendarC() //初始化日历的设置
{
...
function writeIframe()
{
    ...
    "        <td width=60 id=meizzHourHead  title='点击此处选择小时' onclick='parent.funHourSelect(parseInt(this.innerHTML , 10))'"+
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
    "    <td width=50 id=meizzMinuteHead title='点击此处选择分钟' onclick='parent.funMinuteSelect(parseInt(this.innerHTML , 10))'"+
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
    "    <td width=50 id=meizzSecondHead title='点击此处选择秒' onclick='parent.funSecondSelect(parseInt(this.innerHTML , 10))'"+
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.WebCalendar.lightColor; this.style.color=parent.WebCalendar.wordColor'></td>"+
    ...
    with(WebCalendar.iframe)
    {
        ...
        document.close();
       // alert(WebCalendar.iframe.document.getElementById('tableWeek'));
        for(var i=0; i<39; i++)
        {
...
function WebCalendarElement(id)
{
	return WebCalendar.iframe.document.getElementById(id);
}
function writeCalendar() //对日历显示的数据的处理程序
{
    ...
    WebCalendarElement('meizzYearHead').innerHTML   = y +" 年";
    WebCalendarElement('meizzYearMonth').innerHTML  = parseInt(m, 10) +" 月";
    WebCalendarElement('meizzHourHead').innerHTML  =appendZero(parseInt(h, 10)) +" 时";
    WebCalendarElement('meizzMinuteHead').innerHTML  =appendZero(parseInt(mi, 10)) +" 分";
    WebCalendarElement('meizzSecondHead').innerHTML  =appendZero(parseInt(s, 10))+" 秒";
...
{
    if(WebCalendar.eventSrc != winevent(e)) hiddenCalendar();
}
