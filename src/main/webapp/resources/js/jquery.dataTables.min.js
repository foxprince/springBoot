...
e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"首页",sLast:"末页",sNext:"下页",sPrevious:"上页"},sEmptyTable:"无记录",sInfo:"显示 _START_ 至 _END_ ，共 _TOTAL_ 条",
sInfoEmpty:"无记录",sInfoFiltered:"(过滤自总 _MAX_ 记录)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"每页 _MENU_ 条",sLoadingRecords:"载入中...",sProcessing:"处理中...",sSearch:"搜索:",sUrl:"",sZeroRecords:"没有找到匹配记录"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET"};
